...
The corpus contains text, Markdown, code, and fixed-size image placeholders. It replays text locally and does not call a model API. See [benchmark methodology](benchmarks/README.md).
